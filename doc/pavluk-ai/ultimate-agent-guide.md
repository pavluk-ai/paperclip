...
- Mobile feature and UX issue by default: Marionette MCP
- Scripted mobile release gate: Maestro runners
- Hardening or release milestone on mobile: both Marionette and Maestro
- Only use a fallback path when the runtime-contract explicitly allows it.
