...
import {
  ...
  readIssueExecutionPolicyFollowUpMode,
...
export function issueService(db: Db) {
  ...
  return {
    ...
    getWakeableParentAfterChildCompletion: async (parentIssueId: string) => {
      ...
      const childIdsForSummaries = blockingChildren
      ...
      const childIssueSummaries: ChildIssueCompletionSummary[] = blockingChildren
        .slice(0, MAX_CHILD_COMPLETION_SUMMARIES)
        .map((child) => ({
          ...child,
      ...
      return {
        ...
        childIssueSummaries,
        childIssueSummaryTruncated: blockingChildren.length > childIssueSummaries.length,
      };
    },
